...
The Flutter app is a **host**. It does not ship your scripts. Users install packs by manifest URL (**Settings → Sources → Forja → Add plugin**). Official reference packs live in this repository; fork them or publish your own CDN/GitHub raw URLs.

**See also:** [README.md](../README.md) (pack inventory) · [contract.json](contract.json) (machine-readable contracts + JS kits) · Forja host RFCs live in the [Forja](https://github.com/mGhassen/Forja) repo.
...
- Prefer a local pack `_kit.js` that wraps shared helpers, or point `prelude` at `../sdk/catalog-kit.js` / `../sdk/torrent-kit.js` from the pack folder.
