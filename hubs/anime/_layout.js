  ...
  return {
    pages: {
      anime: {
        ...
        // Visual: trending → continue? → mood-chips → mood-results?
        // → this_season → …
        // Empty Continue / empty mood posters: host kit-edge miss walks past.
        ...
        widgets: [
          ...
          rail('this_season', 'This Season', {
            // ↑ mood posters first, then chips (empty results → miss).
